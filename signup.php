...
<nav class="navbar navbar-expand-lg navbar-light bg-danger">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="nav-item">
				<a href="index.php"class="nav-link text-white">Admin Login</a>
			</li>
			<li class="nav-item">
				<a href="index.php"class="nav-link text-white">User Login</a>
			</li>
			<li class="nav-item">
				<a href="index.php"class="nav-link text-white">Register</a>
			</li>
		</ul>
	</div>
</nav>
		...
		<div class="col-md-8"id="main_content">
			...
			<form action="register.php"method="post">
				...
				<div class="form-group">
					...
					<textarea row="3"cols="40"name="address"placeholder="Enter Your Address"class="form-control"></textarea>
				</div>
