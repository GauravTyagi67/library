...
<div class="container-fluid mt-3">
	<div class="row">
		...
		<div class="col-md-4">
			<h2 style="color: red;"><center><b>Add New Category</b></center></h2>
			<form action=""method="post">
				<div class="form-group">
					<label>Category Name</label>
					<input type="text" name="cat_name"class="form-control"placeholder="Enter Category Name"required="">
				</div>
				<button class="btn btn-success"name="add_cat">Add New Category</button>
			</form>
		</div>
		<div class="col-md-4"></div>
	</div>
...
<?php
	if(isset($_POST['add_cat']))
	{
		...
		//This is a database add category validations query
