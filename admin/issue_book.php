...
<div class="container-fluid mt-3">
	<div class="row">
		...
		<div class="col-md-4">
			<h2 style="color: red;"><center><b>Book Issued</b></center></h2>
			<form action=""method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="book_no"class="form-control"placeholder="Enter Book Number"required="">
				</div>
				<div class="form-group">
				...
				<button class="btn btn-success"name="issue_book">Book Issued</button>
			</form>
		</div>
		<div class="col-md-4"></div>
	</div>
...
<?php
	if(isset($_POST['issue_book']))
	{
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"library");
		//This is a database issue book validations query
		$query = "insert into issued_books values(null,'$_POST[book_name]','$_POST[book_author]',$_POST[book_no],$_POST[student_id],1,'$_POST[issue_date]')";
		$query_run = mysqli_query($connection,$query);
	}
?>